...
2.  (NATALIE EXPLAIN specific command or steps to install Now Prototype It).
3.  Verify the installation by running (NATALIE EXPLAIN command to check the installation).
